...
#[derive(Debug)]
pub struct MorganLoggerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MorganLoggerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MorganLogger processing");
    
    let mut processor = MorganLoggerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MorganLoggerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MorganLoggerProcessor::new(false);
